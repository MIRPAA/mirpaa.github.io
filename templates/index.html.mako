...
<body>
    ...
    <header class="top-bar">
        <div class="container">
            <nav class="quick-links">
                <a href="https://wa.me/" target="_blank" class="link-whatsapp" title="WhatsApp">
                ...
                <a href="https://www.maccabi4u.co.il/" target="_blank" class="link-maccabi" title="מכבי שירותי בריאות">
                    מכבי
                </a>
                <a href="https://maps.app.goo.gl/iJ9QCuzAm2wFzs3s9" target="_blank" class="link-maps" title="מיקום המרפאה">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
    ...
    <footer>
        <div class="container">
            <p>&copy; 2025 מרפאת ילדים. כל הזכויות שמורות.</p>
        </div>
    </footer>
</body>
</html>
